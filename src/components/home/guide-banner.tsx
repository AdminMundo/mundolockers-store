    ...
    <section className="bg-[#EEEDEB] text-zinc-900">
      <div className="mx-auto max-w-6xl px-4 py-10">
        <Link
          ...
          className="group flex flex-col items-start gap-5 rounded-3xl border border-black/10 bg-white p-7 shadow-sm transition hover:border-[#0477BF] hover:shadow-[0_10px_30px_rgba(4,119,191,0.12)] sm:flex-row sm:items-center sm:justify-between md:p-9"
        >
