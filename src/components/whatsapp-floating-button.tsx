...
export default function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/25 transition hover:scale-105 hover:bg-[#20bd5a] lg:bottom-6 lg:right-6"
    >
