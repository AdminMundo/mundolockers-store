        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="w-full sm:max-w-[420px]">
            <input
              ...
              placeholder="Buscar…"
              className="w-full rounded-full border border-zinc-200 bg-white px-4 py-2 text-sm outline-none focus:border-[#0477BF] focus:shadow-[0_0_0_3px_rgba(4,119,191,0.18)]"
            />
          </div>
                ...
                {canPurchase ? (
                  <>
                    <button
                      ...
                      className="rounded-full border border-zinc-200 bg-white px-4 py-2.5 text-sm font-medium text-zinc-900 transition hover:border-[#0477BF] hover:shadow-[0_0_0_3px_rgba(4,119,191,0.15)]"
                    >
                      Añadir al carrito
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-full bg-black px-4 py-2.5 text-sm font-medium text-white transition-colors duration-200 hover:bg-[#0477BF] hover:text-white"
                    >
                      Comprar ahora
                    </button>
                  </>
