        ...
        <div className="relative flex min-h-60 flex-col justify-between gap-8 p-6 md:flex-row md:items-end md:p-8">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center rounded-2xl bg-[#0477BF] px-4 py-2.5 text-sm font-medium text-white transition hover:brightness-95"
            >
              Nuevo producto
            </Link>
            <Link
                  ...
                  >
                    ...
                    <td className="px-6 py-4 align-top">
                      <div className="min-w-[240px]">
                        ...
                        {product.is_featured ? (
                          <span className="mt-2 inline-flex rounded-full bg-[#0477BF]/20 px-2.5 py-1 text-xs font-medium text-black">
                            Destacado
                          </span>
                        ) : null}
                      </div>
